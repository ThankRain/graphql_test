...
public class FollowingQuery: GraphQLQuery {
  public static let operationName: String = "Following"
  ...
  public struct Data: MySchema.SelectionSet {
    ...
    public struct User: MySchema.SelectionSet {
      ...
      public static var __selections: [Selection] { [
        .field("following_users", [Following_user].self, arguments: [
          "skip": .variable("skip"),
      ...
      /// 关注的用户
      public var following_users: [Following_user] { __data["following_users"] }

      /// User.Following_user
      ///
      /// Parent Type: `User`
      public struct Following_user: MySchema.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
        ...
        /// User.Following_user.User_count
        ///

...
public class UserMarkedPostQuery: GraphQLQuery {
  public static let operationName: String = "UserMarkedPost"
  ...
  public struct Data: MySchema.SelectionSet {
    ...
    public struct User: MySchema.SelectionSet {
      ...
      public static var __selections: [Selection] { [
        .field("favorite_posts", Favorite_posts.self, arguments: [
          "time": .variable("time"),
      ...
      /// 收藏的帖子
      public var favorite_posts: Favorite_posts { __data["favorite_posts"] }

      /// User.Favorite_posts
      ///
      /// Parent Type: `PostConnection`
      public struct Favorite_posts: MySchema.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
        ...
        public struct Node: MySchema.SelectionSet {
          ...
          /// User.Favorite_posts.Node.Author
          ///
          /// Parent Type: `User`
